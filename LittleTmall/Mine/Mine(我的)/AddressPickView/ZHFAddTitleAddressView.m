...
-(UIView *)initAddressView{
    ...
    self.addAddressView.frame = CGRectMake(0, screen_height-kNavBarAndStatusBarHeight, screen_width, _defaultHeight);
...
-(void)addAnimate{
    ...
    [UIView animateWithDuration:0.2 animations:^{
        self.addAddressView.frame = CGRectMake(0, screen_height-kNavBarAndStatusBarHeight - self.defaultHeight, screen_width, self.defaultHeight);
    }];
}
-(void)tapBtnAndcancelBtnClick{
    self.hidden = NO;
    [UIView animateWithDuration:0.2 animations:^{
         self.addAddressView.frame = CGRectMake(0, screen_height-kNavBarAndStatusBarHeight, screen_width, 200);
